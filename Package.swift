...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/OperatorFoundation/Flower.git", from: "0.1.14"),
        ...
        .package(url: "https://github.com/OperatorFoundation/TransmissionTransport.git", from: "0.2.5"),
