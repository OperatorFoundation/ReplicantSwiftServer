...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/OperatorFoundation/Transmission.git", from: "1.2.3"),
        .package(url: "https://github.com/OperatorFoundation/TransmissionTransport.git", from: "1.1.3"),
